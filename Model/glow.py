...
class FlowPostNet(nn.Module):
    ...
    def __init__(self, preprocess_config, model_config):
        ...
        hidden_channels = model_config["Glow"]["wn_hidden"]
        kernel_size = model_config["Glow"]["wn_kernel_size"]
        dilation_rate = 1
        n_blocks = model_config["Glow"]["flow_step"]
        n_layers = model_config["Glow"]["wn_layer"]
        p_dropout = model_config["Glow"]["flow_dropout"]
        n_split = model_config["Glow"]["n_split"]
        n_sqz = model_config["Glow"]["n_sqz"]
        sigmoid_scale = model_config["Glow"]["sigmoid_scale"]
        gin_channels = model_config["Decoder"]["hidden"]
        shared_group = model_config["Glow"]["shared_group"]
